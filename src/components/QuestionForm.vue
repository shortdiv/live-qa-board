<template>
  <div>
    <form name="ask-question" netlify-honeypot="nickname" action="/" netlify>
      ...
      <p>
        <label v-for="panelist in panelists">
          <input
            type="radio"
            name="panelist"
            :value="panelist"
            :checked="askPerson === panelist"
          >
          <span>Ask {{ panelist }}</span>
        </label>
      </p>
      <p>
        <label>
      ...
      <p>
        <button type="submit" class="button">Ask a question</button>
      </p>
    </form>
  </div>
</template>
